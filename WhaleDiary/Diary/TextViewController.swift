...
//        }
    ...
    override func viewDidLoad() {
        ...
        editView.t_viewController = self
    ...
    func updateInset() {
        ...
        self.editView.contentInset = UIEdgeInsets(top: 0, left: inset + 8, bottom: 20, right: inset)
        _textWidth = 0
    }
...
extension TextViewController: UITextViewDelegate {
    ...
    func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        if abs(scrollView.contentOffset.y - lastOffsetY) < 500 {
            return
        }
        timer?.invalidate()
