...
//    if ([currentViewController isKindOfClass:[FloatingTabBarController class]]){
//        currentViewController = [(FloatingTabBarController *)currentViewController currentViewController];
//    }
...
+ (UINavigationController *)getCurrentNav{
    return [self getCurrentController].navigationController;
}
